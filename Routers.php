    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navtest">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="Shoppingcart.html">Shoping Cart <span class="sr-only">(current)</span></a></li>
  ...
  <section class="price_table text-center">
    <div class="container">
      ...
      <div class="row">
        ...
        $stmt = $pdo->query("SELECT Price_disc,name, Price FROM items where types='router'");
